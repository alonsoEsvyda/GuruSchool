...
<html>
<head>
  <title>Certificados | Gurú School</title>
  <meta name=" title" content="Certificados | Gurú School">
...
<body>
  <!--Navigation-->
   ...
   <!--Front-->
    <section style="background-image: url('css/imagenes/fondo-certificado.png');background-size: 100% 100%; no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;" id="sec-front" class="padding margin-top">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12">
    ...
    <section class="intermediate steps1">
      <div class="container">
        <div class="row hidden-xs">
          ...
          <div class="col-md-6">
            <a data-toggle="modal" data-target="#myModal"><img class="imgstep1 wow bounceInRight" data-wow-duration="1s" data-wow-delay="0.5s"  src="css/imagenes/Certificado.png"></a>
            <!-- Modal -->
            <div class="modal fade" id="myModal" role="dialog">
              <div class="modal-dialog">
                <center><img style="width:130%; margin-left:-80px;" src="css/imagenes/Certificado.png"></center>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row visible-xs">
          <div class="col-xs-12">
            <center>
              <h1>Tu certificado es así!</h1>
              <p>Este es el certificado de participación disponible en casi la mayoría de nuestros cursos, simplemente termina el 100% del curso y Boalá, automáticamente lo tienes.</p>
              <img  class="imgstep1-res wow bounceInRight" data-wow-duration="1s" data-wow-delay="0.5s"  src="css/imagenes/Certificado.png">
            </center>
          </div>
        </div>
      </div>
    ...
    <section class="intermediate steps2">
      <div class="container">
        ...
        <hr>
        <div class="col-md-6">
            <img class="imgstep3 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.5s" src="css/imagenes/ipad.png">
          </div>
          <div class="col-md-6">
    ...
    <center>
      <img class="img-class wow bounceInUp hidden-xs" data-wow-duration="1s" src="css/imagenes/hand.jpg">
      <img style="width:100%;" class="img-class wow bounceInUp visible-xs" data-wow-duration="1s" src="css/imagenes/hand.jpg">
    </center>
    <!--Footer-->
