                ...
                ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <a href="../my-certificate"><li class="dropdown-item"><i class="fa fa-certificate" aria-hidden="true"></i> Mis Certificados</li></a>
                            <a href="../teach/teacher"><li class="dropdown-item"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Enseño</li></a>
                            <a href="../learn"><li class="dropdown-item"><i class="fa fa-book" aria-hidden="true"></i> Aprendo</li></a>
                            <a href="list-my-job"><li class="dropdown-item"><i class="fa fa-suitcase" aria-hidden="true"></i> Empleos</li></a>
                            <a href="../data_user"><li class="dropdown-item"><i class="fa fa-database" aria-hidden="true"></i> Mis Datos</li></a>
                            <a href="../security"><li class="dropdown-item"><i class="fa fa-lock" aria-hidden="true"></i> Seguridad</li></a>
                            <a href="../session/logout"><li class="dropdown-item"><i class="fa fa-times" aria-hidden="true"></i> Salir</li></a>
                        </ul>
                    </li>
                <?php    
                }
